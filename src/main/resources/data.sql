...
-- DATA STORE
INSERT INTO data_store(data_store_type_id, url, driver_class, username, password, table_types) VALUES (1, 'jdbc:mysql://localhost/clover?autoReconnect=true', 'com.mysql.jdbc.Driver', 'developer','temporal123', 'TABLE,VIEW');
...
INSERT INTO rule(rules_types_id, expression, replacement) VALUES (1, 'os$', 'o');